...
export type EventType = "" | "showContextMenu" | "showProductionSelector" | "confirmationPrompt";
...
export type AllowedEventTypes = EmptyEvent | ShowContextMenuEvent | ShowProductionSelectorEvent | ConfirmationPromptEvent;
